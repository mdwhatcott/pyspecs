...
class TestShouldAssertions(TestCase):
    ...
    def test_raises_with_incorrect_error_message(self):
        def raise_(): raise KeyError("Specific Error Message")
        self._fails(lambda:
            this(raise_).should.raise_a(KeyError, "Wrong Error Message"),
            "Raised 'KeyError' as expected but with an " \
    ...
    def test_raises_with_correct_error_message(self):
        def raise_(): raise KeyError("Specific Error Message")
        self._passes(lambda:
            this(raise_).should.raise_a(KeyError, "Specific Error Message"))
        self._passes(lambda:
            this(raise_).should.raise_an(KeyError, "Specific Error Message"))
    ...
    def test_failing_empty(self):
        self._fails(
            lambda: this('asdf').should.be_empty(),
